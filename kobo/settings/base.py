...
DEFAULT_FROM_EMAIL = env.str(
    'DEFAULT_FROM_EMAIL', 'DataMovin <hola@movin.com.ar>'
)
...
CONSTANCE_CONFIG = {
    ...
    'REGISTRATION_BLACKLIST_ERROR_MESSAGE': (
        'Account creation is managed by DataMovin. Please contact '
        'hola@movin.com.ar for assistance.',
    ...
    'SUPPORT_EMAIL': (
        env.str('KOBO_SUPPORT_EMAIL', 'hola@movin.com.ar'),
    ...
    'SUPPORT_URL': (
        ...
        'URL for DataMovin support and help',
    ),
    'ACADEMY_URL': (
        env.str('KOBO_ACADEMY_URL', ''),
        'Optional URL for DataMovin Academy; leave blank to hide it',
    ),
    'COMMUNITY_URL': (
        env.str('KOBO_COMMUNITY_URL', ''),
        'Optional URL for DataMovin Community; leave blank to hide it',
    ),
    ...
    'PROJECT_OWNERSHIP_ADMIN_EMAIL_SUBJECT': (
        'DataMovin Notifications: Project ownership transfer failure',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'DataMovin Primary API',
    'DESCRIPTION': (
        'This page documents all DataMovin API endpoints, except for those '
    ...
    'SWAGGER_UI_FAVICON_HREF': '/static/datamovin-favicon.png',
    'SWAGGER_UI_SETTINGS': {
        'filter': True,
...
SPECTACULAR_OPENROSA_TITLE = 'DataMovin OpenRosa API'

SPECTACULAR_OPENROSA_DESCRIPTION = (
    'Welcome to the documentation for the DataMovin OpenRosa API. Data collection '
    ...
    'Our separate documentation of the primary DataMovin API endpoints, used to '
...
"""
Stripe configuration for deployments that track usage limit exceptions.
"""
