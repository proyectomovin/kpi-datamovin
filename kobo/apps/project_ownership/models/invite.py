...
class Invite(AbstractTimeStampedModel):
    ...
    def send_acceptance_email(self):
        ...
        email_message = EmailMessage(
            ...
            subject=t('DataMovin project ownership transfer accepted'),
    ...
    def send_invite_email(self):
        ...
        email_message = EmailMessage(
            ...
            subject=t(
                'Action required: DataMovin project ownership transfer request'
            ),
    ...
    def send_refusal_email(self):
        ...
        email_message = EmailMessage(
            to=self.sender.email,
            subject=t('DataMovin project ownership transfer incomplete'),
