...
Examples:
```shell
  curl -X GET https://kf.data.movin.com.ar/api/v2/languages/?q=fr
```
...
Examples:
```shell
  curl -X GET https://kf.data.movin.com.ar/api/v2/languages/?q=transcription_services__code:goog AND translation_services__code:goog
```
