...
```curl
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/aSAvYreNzVEkrWg5Gdcvg/data/451/attachment/?xpath=Upload_a_file
```
...
```curl
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/aSAvYreNzVEkrWg5Gdcvg/data/451/attachment/?xpath=Upload_a_file&format=mp3
```
