...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid}/data/
```
...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid}/data/?start=0&limit=10
```
...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid}/data/?query={"__version__": "vWvkKzNE8xCtfApJvabfjG"}
curl https://kf.data.movin.com.ar/api/v2/assets/{uid}/data/?query={"_submission_time": {"$gt": "2019-09-01T01:02:03"}}
```
