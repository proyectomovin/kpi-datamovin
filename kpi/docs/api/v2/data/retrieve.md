...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid_asset}/data/{id}.xml
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid_asset}/data/{id}.json
```

or

```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid_asset}/data/{id}/?format=xml
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/{uid_asset}/data/{id}/?format=json
```
