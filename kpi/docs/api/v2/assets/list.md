...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/?ordering=-name
```
...
```shell
curl -X GET https://kf.data.movin.com.ar/api/v2/assets/?collections_first=true&ordering=-name
```
