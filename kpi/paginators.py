        ...
        return {
            ...
            'properties': {
                ...
                'next': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'https://kf.data.movin.com.ar/accounts/?{offset_param}=400&{limit_param}=100'.format(  # noqa E501
                ...
                'previous': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'https://kf.data.movin.com.ar/accounts/?{offset_param}=200&{limit_param}=100'.format(  # noqa E501
                        offset_param=self.offset_query_param,
                        limit_param=self.limit_query_param,
                    ),
                },
