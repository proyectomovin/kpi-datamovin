...
test = t(
  'This question could not be imported. Please re-create it manually. Please contact us at hola@movin.com.ar so we can fix this bug!',
)
test = t('Add Question')
test = t('or')
test = t('Import XLS')
...
test = t(
  'The server encountered an error while trying to deploy the project. If this problem persists, please contact <a href="mailto:hola@movin.com.ar">hola@movin.com.ar</a>.',
)
