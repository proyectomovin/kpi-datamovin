...
class HelpBubble extends React.Component<HelpBubbleProps, HelpBubbleState> {
  ...
  interpolateMessageUserInfo(htmlString: string) {
    return htmlString
      ...
      .replace('##user_full_name##', this.props.userFullName || t('DataMovin user'))
  }
        ...
        <bem.HelpBubble__popupContent>
          ...
          {envStore.isReady && envStore.data.community_url && (
            ...
            >
              ...
              <p>
                {t(
                  'Connect with DataMovin support for help with field data collection, offline capture, and synchronization.',
                )}
              </p>
            </bem.HelpBubble__rowAnchor>
          )}
          ...
          {envStore.isReady && envStore.data.academy_url && (
            ...
            >
              ...
              <header>{t('DataMovin Learning')}</header>
              <p>{t('Explore guided resources for field data collection, offline capture, and synchronization.')}</p>
            </bem.HelpBubble__rowAnchor>
          )}
